//timestamp:Fri Nov 05 11:51:38 JST 2021
...
Math.sampleWeb_random=function(double){
	...
	idx=block%255;block=Math.floor(u/25500000000.0);result.push(0.0+1.0*idx);result.push(1.0);
	idx=block%255;block=Math.floor(u/6502500000000.0);result.push(0.0+1.0*idx);result.push(1.0);
	idx=block%255;block=Math.floor(u/1658137500000000.0);result.push(0.0+1.0*idx);result.push(1.0);
