//timestamp:Sun Aug 15 19:03:28 JST 2021
...
Math.sampleWeb2_random=function(double){
	...
	idx=block%100;block=Math.ceil(u/10000000000.0);result.push(0.1+0.028999999999999998*idx);result.push(0.028999999999999998);
	idx=block%100;block=Math.ceil(u/1000000000000.0);result.push(0.0+0.06283185307179587*idx);result.push(0.06283185307179587);
	idx=block%100;block=Math.ceil(u/100000000000000.0);result.push(0.0+0.06283185307179587*idx);result.push(0.06283185307179587);
	idx=block%100;block=Math.ceil(u/10000000000000000.0);result.push(0.0+0.06283185307179587*idx);result.push(0.06283185307179587);
	idx=block%255;block=Math.ceil(u/2.55e+18);result.push(0.0+1.0*idx);result.push(1.0);
	idx=block%255;block=Math.ceil(u/6.5025e+20);result.push(0.0+1.0*idx);result.push(1.0);
	idx=block%255;block=Math.ceil(u/1.6581374999999998e+23);result.push(0.0+1.0*idx);result.push(1.0);
